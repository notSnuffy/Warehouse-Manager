...
class ShapeEditor extends Phaser.Scene {
  ...
  async create() {
    ...
    container.getTopLeft = function () {
            ...
            const rotatedLocalX = localX * Math.cos(this.rotation) - localY * Math.sin(this.rotation);
            const rotatedLocalY = localX * Math.sin(this.rotation) + localY * Math.cos(this.rotation);
