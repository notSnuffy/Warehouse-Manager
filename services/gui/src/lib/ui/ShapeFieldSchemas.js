  ...
  fields: [
    {
      ...
      name: "shapeX",
      label: "X Position",
      attributes: { required: true, value: 0 },
...
const RotationSchema = {
  ...
  attributes: { required: true, value: 0, min: 0, max: 360 },
  ...
  fields: [
    {
      ...
      name: "shapeWidth",
      label: "Width",
      attributes: { required: true, value: 100, min: 10 },
...
const ColorSchema = {
  ...
  name: "shapeColor",
  label: "Color",
  attributes: { required: true, value: "#563d7c", title: "Choose your color" },
...
const RadiusSchema = {
  ...
  name: "shapeRadius",
  label: "Radius",
  attributes: { required: true, value: 50, min: 5 },
...
const ArcAngleSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      name: "shapeEndAngle",
      label: "End Angle",
      attributes: { required: true, value: 180, min: 0, max: 360 },
      validation: { event: "change", handler: validateAngle },
    },
  ],
};
